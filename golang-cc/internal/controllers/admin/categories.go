...
func (c *Controller) CreateCategory(ctx *gin.Context) {
	...
	id, err := c.service.CreateCategory(ctx.Request.Context(), input.Name)
	if err != nil {
...
func (c *Controller) UpdateCategory(ctx *gin.Context) {
	...
	if err := c.service.UpdateCategory(ctx.Request.Context(), ctx.Param("id"), input.Name, *input.IsActive); err != nil {
...
func (c *Controller) DeleteCategory(ctx *gin.Context) {
	err := c.service.DeleteCategory(ctx.Request.Context(), ctx.Param("id"))
	if isNotFound(err) {
