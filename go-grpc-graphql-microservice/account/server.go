...
import (
	...
	"github.com/mai92107/go-grpc-graphql-microservice/account/pb/github.com/mai92107/GO-GRPC-GraphQL-Microservice/account/pb"
...
func (s *grpcServer) GetAccounts(ctx context.Context, r *pb.GetAccountsRequest) (*pb.GetAccountsResponse, error) {
	...
	accounts := []*pb.Account{}
	for i, a := range res {
		accounts[i] = &pb.Account{Id: a.ID, Name: a.Name}
	}
